...
{
    public class ClusterFaces : GH_Component
    {

        public ClusterFaces()
          : base("Cluster.Faces", "Cluster.Faces", "Returns the Faces constituent to the Cluster.", "Topologic", "Cluster")
        {
        }
        ...
        {
            get { return new Guid("a11943a3-ab4c-4a30-82be-1e79e2df8743"); }
        }
    }
}