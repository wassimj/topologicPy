...
{
    public class FaceUtilityNormalAtParameters : GH_Component
    {

        public FaceUtilityNormalAtParameters()
          : base("FaceUtility.NormalAtParameters", "FaceUtility.NormalAtParameters", "Returns the normal (vector) at a parameter of a Face.", "TopologicUtilities", "FaceUtility")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.SetData(1, normal[1]);
            DA.SetData(2, normal[2]);
        }
        ...
        {
            get { return new Guid("56086ec8-1f8b-4c24-b56a-4154f9d7c61a"); }
        }
    }
}
