...
{
    public class WireEdges : GH_Component
    {

        public WireEdges()
          : base("Wire.Edges", "Wire.Edges", "Returns the Edges constituent to the Wire. NOTE: This method will automatically identify its loop order property.", "Topologic", "Wire")
        {
        }
        ...
        {
            get { return new Guid("9eff722e-4f77-4afb-a871-c8854fbe61f3"); }
        }
    }
}
