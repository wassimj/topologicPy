...
{
    public class FaceSharedVertices : GH_Component
    {

        public FaceSharedVertices()
          : base("Face.SharedVertices", "Face.SharedVertices", "Returns the shared Vertices between two Faces.", "Topologic", "Face")
        {
        }
        ...
        {
            get { return new Guid("ebf35282-5d01-471b-b6c7-934f809c3b40"); }
        }
    }
}
